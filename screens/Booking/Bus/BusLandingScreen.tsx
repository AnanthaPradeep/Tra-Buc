...
type NavigationProp = StackNavigationProp<RootStackParamList, 'BusLandingScreen'>;

const BusLandingScreen: React.FC = () => {
  ...
  const handleNavigateToTrain = () => {
    navigation.navigate('TrainLandingScreen'); // Navigate to TrainLandingScreen
  };

  // Items for Other Services
  const allServices = [
    { name: "Booked Bus", icon: "ticket" },
    { name: "PNR Status", icon: "list" },
    { name: "Order Food", icon: "fast-food" },
    { name: "Running Status", icon: "bus" },
      ...
      <ScrollView contentContainerStyle={styles.contentContainer}>
        ...
        <View style={styles.navOptions}>
          <TouchableOpacity style={styles.navItem}>
            <Ionicons name="train" size={30} color="#008080" />
          ...
          <TouchableOpacity style={styles.navItem} onPress={handleNavigateToTrain}>
  ...
  <ScrollView horizontal showsHorizontalScrollIndicator={false}>
    <View style={styles.offerCards}>
      ...
      {/* Add more offer cards here if needed */}
    </View>
  </ScrollView>
</View>
...
const styles = StyleSheet.create({
  ...
  contentContainer: { paddingBottom: 100 }, // Add padding to prevent content from being hidden behind the footer
  ...
  navText: { marginTop: 5, fontSize: 12, color: '#008080' },
  ...
  datePickerText: { fontSize: 14, color: '#008080', marginLeft: 10 },
  ...
  sectionTitle: { fontSize: 18, fontWeight: 'bold', color: '#008080' },
  servicesGrid: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between' },
  serviceItem: { alignItems: 'center', width: '30%', marginVertical: 10 },
  serviceText: { marginTop: 5, fontSize: 12, color: '#008080' },
  ...
  iconButton: { padding: 10, alignItems: 'center', color: '#008080' },
  ...
  offerCardsContainer: { padding: 10, backgroundColor: '#fff', margin: 10, borderRadius: 10 },
  offerCard: {
    backgroundColor: '#fff',
    padding: 10,
    marginHorizontal:10,
  ...
  offerCardTitle: { fontSize: 16, fontWeight: 'bold', color: '#008080' },
  offerCardDescription: { fontSize: 12, color: '#008080' },
  otherServicesHeader: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
...
export default BusLandingScreen;
